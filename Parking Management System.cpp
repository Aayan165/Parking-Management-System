#include <conio.h>//used for console input and ooutput function
#include <stdio.h>
#include <string.h>
#include <windows.h>//used for animations
#include <time.h>//calculate time for parked and unparked vehicle
#include <stdlib.h>

#define MAX_ROWS 10//for default maps creation
#define MAX_COLS 10//for default maps creation
#define MAX_CAPACITY 5//for waiting list feature
#define WAITLIST_CAPACITY 5//for waiting list feature

typedef struct {
    char username[50];
    char password[50];
} Credentials; //structure for password authentication
...
typedef struct {
	...
	time_t t;
	time_t u;
} vehicle;// structure for our management system

vehicle parked[MAX_ROWS * MAX_COLS] = {0};// initialize parked arraay with zero to reduce garbage effect
vehicle waitingList[WAITLIST_CAPACITY] = {0};//initialize waiting list  arraay with zero to reduce garbage effect
vehicle history[1000];//initialize parked arraay with zero to reduce garbage effect
int historyCount = 0;//

void animate(char str[],int length);//functions for animation
void setColor();//function to set color
void fillArea();//function to fill parking space
void selection();
void adminLogin();//fnction for admin login page
void adminMenu();//function for admin menu
void createParkingArea();//function to create parking area
void displayParkingArea(int n);//function to display parking area
void displayParkedVehiclesList();//function to display parked vehicle list
void displayBanner();//function to display banner
void searchVehicle();//function to display search vehicle
void viewHistory();//function to viewhistory
int extra_services(int total);// find extra service function
void userMenu();//function for usermenu
void parkVehicle();//function for parkedvehicle
void unparkVehicle();//function for unpark vehicle
void header();//function to display headerfile
void exit();//function for exit
void loadVehicles();//function to load vehicle
void saveVehicles();//function to save vehicle information
void saveVehicles();
void notify(const char *message);//function to notify message for waitiing list in car
void shiftVehicleFromWaitlist();//function to automatically shift vehicle to waiting list
void generateAdminReport();// function to generate admin report


//function to setcolor which is used in whole document
...
//function to load Vehicle when it is run
void loadVehicles() {
...
// function to automatically shift vehicle from waiting list to parked vehicle list  
...
//function for waiting list whether is in waiting list or not
...
//function to save vehicle inforation 
void saveVehicles() {
	FILE * fptr;
...
//used for owner to customly create parking area
...
//function to display parking area customly
...
//function to display our first  page  with animation 
void displayBanner() {
	system("color F0");
...
//function for displaying parked Vehicle
...
//function for admin menu after successfully login
void adminMenu() {
...
//function for calculate charges based on duration 
...
//function for calculate the time when the car is unparked
...
//function to calculate extra service
...
//function for search vehicle based on plate number
void searchVehicle() {
	system("cls");
	setColor(4,0);
	printf("-----------------------------------------------------------------------------------------------------------------------\n|");
